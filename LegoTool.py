...
class LegoTool(object):
    ...
    def __init__(self):
        ...
        self.uWidth = mc.intSliderGrp( field=True, label='Width', minValue=1, maxValue=15, fieldMinValue=1, fieldMaxValue=100, value=2 )
        self.uLength = mc.intSliderGrp( field=True, label='Length', minValue=1, maxValue=15, fieldMinValue=1, fieldMaxValue=100, value=4 )
    ...
    def createLego(self, uLength = 4, uWidth = 2, fl = False):
        # Brick constants 
        unitHeight = 0.17
        unitWidth = 0.8
        thickness = 0.12
